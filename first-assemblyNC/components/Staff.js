...
const Staff = () =>{
    ...
    return(
        <LinearGradient
            ...
            <ScrollView>
            <Card style={{flexDirection:'right'}} containerStyle={{backgroundColor:'#1B1B1B', borderColor:'#1E1F21', borderRadius:20}}>
                 <Card.Title style={{fontSize:25, color:'#F9F9F9'}}>Pastor Steve DeSantis</Card.Title>
